...
CDS_fasta$sequence <- gsub("N","",CDS_fasta$sequence)
...
CDS_fasta$STP <- NULL
CDS_fasta[2338:2357] <- (CDS_fasta[2338:2357]/CDS_fasta$AA_length)*100
...
Library_V2 <- merge(Library_V2,IDs_genenames_coding,by.x="tx.id",by.y="ensembl_transcript_id",all=T)
dim(Library_V2)
...
Library_V2 <- subset(Library_V2,Library_V2$gene_biotype=="protein_coding")
